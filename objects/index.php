...
<?$APPLICATION->IncludeComponent("bitrix:news", "with_new_filter", Array(
	"ADD_ELEMENT_CHAIN" => "Y",	// Включать название элемента в цепочку навигации
		...
		"PAGER_TITLE" => "Объекты",	// Название категорий
		...
		"SORT_BY1" => "PROPERTY_PARTNER",	// Поле для первой сортировки новостей
		...
		"SEF_FOLDER" => "/objects/",	// Каталог ЧПУ (относительно корня сайта)
