<div class="page-hero-fastfacts row">
        ...
        <div class="fastfacts__item_wrap">
            <span class="fastfacts__icon">
                <svg aria-hidden="true" width="37" height="45">
                    <use xlink:href="#hist-obj-10-1"></use>
                </svg>
            </span>
            <div class="fastfact-info">
                ...
                <span class="fastfact-text">
                    Именно здесь проектировались алтайские заводы, рудники и населённые пункты
                </span>
            </div>
        </div>
    </div>
        ...
        <div class="fastfacts__item_wrap">
            <span class="fastfacts__icon">
                <svg aria-hidden="true" width="37" height="44">
                    <use xlink:href="#hist-obj-10-2"></use>
                </svg>
            </span>
            <div class="fastfact-info">
                <div class="fastfact-title">
                ...
                <span class="fastfact-text">
                    количество оконных проемов в здании
                </span>
            </div>
        </div>
    </div>
        ...
        <div class="fastfacts__item_wrap">
            <span class="fastfacts__icon">
                <svg aria-hidden="true" width="41" height="37">
                    <use xlink:href="#hist-obj-10-3"></use>
                </svg>
            </span>
            <div class="fastfact-info">
                <div class="fastfact-title">
                ...
                <span class="fastfact-text">
                    В резных элементах дома присутствуют образы животных
                </span>
            </div>
        </div>
    </div>
    <div class="cell-5 cell-11-md fastfacts__item">
        <div class="fastfacts__item_wrap">
            <span class="fastfacts__icon">
                <svg aria-hidden="true" width="37" height="44">
                    <use xlink:href="#hist-obj-10-4"></use>
                </svg>
            </span>
            <div class="fastfact-info">
                <div class="fastfact-title">
