            ...
            <?foreach($arResult["ITEMS"] as $arItem):?>
                ...
                <div class="x3-slider__item x3-slide swiper-slide" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
                    ...
                    <div class="x3-slide__data">
                        <div class="container">
                            <div class="x3-slide__name">Карта гостя</div>
                            <a href="/guestcard/" class="x3-slide__btn x3-btn">Получить карту</a>
                        </div>
                    </div>
                </div>
            <?endforeach;?>
        </div>
        <div class="x3-slide__card">
            <img src="<?=$this->__component->__template->__folder?>/images/slider_card.png" alt="">
        </div>
