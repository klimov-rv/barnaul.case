...
\Site\Main\Css::showInlineCssBlock(array(SITE_TEMPLATE_PATH . "/css/search-page.css"));
?>
<div class="x3-search-page">
...
<?endif;?>
	&nbsp;<input class="x3-btn" type="submit" value="<?=GetMessage("SEARCH_GO")?>" />
...
<?elseif(count($arResult["SEARCH"])>0):?>
	...
	<div class="x3-search-list">
        <?foreach($arResult["SEARCH"] as $arItem):?>
            <div class="x3-search-list__item">
                <a class="x3-search-list__name" href="<?echo $arItem["URL"]?>"><?echo $arItem["TITLE_FORMATED"]?></a>
