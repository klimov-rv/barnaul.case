...
MyMap.prototype = {
  ...
  setPoints: function (id_rub, insearch, init) {
    ...
    group.options.set({
      ...
      clusterBalloonHeight: 250, // Высота балуна
        ...
        if ((init && points[p].po == 1) || !init) {
          ...
          group.add(new ymaps.Placemark(
            ...
            [points[p].lo, points[p].la],
            {
              ...
              balloonContentBody: '<div class="mapobj_info"><div class="map_forimg"><a href="' + points[p].nur + '">' + ph + '</a></div><div class="map_inf"><a class="mapobj_tit" href="' + points[p].nur + '">' + points[p].n + '</a><span>' +/*rubs[ points[p].ir ].n*/'' + '</span><p>' + points[p].m + '</p><a href="' + points[p].nur + '" class="map_more">Подробнее</a></div></div>',
            }, {
